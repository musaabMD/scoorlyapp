      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="relative max-w-2xl mx-auto mb-16">
          <Input
            ...
            className="w-full h-14 pl-12 pr-4 text-xl bg-white rounded-xl border-2 border-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300"
          />
